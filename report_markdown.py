...
elements.append(
    Paragraph(f'''
Per progettare/sviluppare questo prototipo viene proposto di procedere in modo "passo-passo" (modalità iterativa). Ovvero, al posto di implementare la versione finale del prototipo, si ritiene opportunto introdurre fasi intermedie. Queste fasi intermedie vengono descritte nel dettaglio in una sezione dedicata.
    ''', body_style,)
)
elements.append(
    Paragraph(f'''
